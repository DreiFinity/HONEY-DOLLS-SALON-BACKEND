...
import PurchaseRepositoryImpl from "./infrastructure/repositories/Purchase/PurchaseRepositoryImpl.js";
import PurchaseRoutes from "./infrastructure/web/routes/PurchaseRoutes.js";
...
app.use("/api/purchase", PurchaseRoutes(purchaseRepository));
